            ...
            <div class="h-screen w-64">
                <div class="flex h-full flex-grow flex-col overflow-y-auto rounded-br-lg rounded-tr-lg bg-white pt-5 shadow-md">
                    <div class="flex mt-10 items-center px-4">
                        <img class="h-12 w-auto max-w-full align-middle" src="@/assets/favicon/bg.png" alt="" />
                        <div class="flex ml-3 flex-col">
                            <h3 class="font-medium">MSFDA</h3>
                    ...
                    <div class="flex mt-3 flex-1 flex-col">
                        <div class="">
                            <nav class="flex-1">
                                <NuxtLink to="/admin/profile" class="flex cursor-pointer items-center py-2 px-4 text-sm font-medium outline-none transition-all border-l-rose-600 duration-100 ease-in-out focus:border-l-4  hover:border-l-4 hover:text-rose-600">
                                    <span class="iconify mr-4 h-6 w-6 align-middle" data-icon="basil:heart-outline"></span>
                                    Profile
                                </NuxtLink>
                                <NuxtLink to="/admin/dashboard" title="" class="flex cursor-pointer items-center py-2 px-4 text-sm font-medium outline-none transition-all duration-100 ease-in-out focus:border-l-4 border-l-rose-600 hover:border-l-4 hover:text-rose-600">
                                    <span class="iconify mr-4 h-5 w-5 align-middle" data-icon="basil:layout-outline"></span>
                                    Dashboard
                                </NuxtLink>
                                <div class="relative transition">
                                    ...
                                    <ul class="duration-400 flex m-2 max-h-0 flex-col overflow-hidden rounded-xl bg-gray-100 font-medium transition-all duration-300 peer-checked:max-h-96">
                                        <li class="flex m-2 cursor-pointer border-l-rose-600 py-3 pl-5 text-sm text-gray-600 transition-all duration-100 ease-in-out hover:border-l-4 hover:text-rose-600">
                                            <span class="mr-5"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                                    <path stroke-linecap="round" stroke-linejoin="round" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" /></svg></span>
                                            Feedback
                                        </li>
                                        <li class="flex m-2 cursor-pointer border-l-rose-600 py-3 pl-5 text-sm text-gray-600 transition-all duration-100 ease-in-out hover:border-l-4 hover:text-rose-600">
                                            <span class="mr-5"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            ...
                            <nav class="flex-1">
                                <NuxtLink to="/blogs" class="flex cursor-pointer items-center border-l-rose-600 py-2 px-4 text-sm font-medium text-gray-600 outline-none transition-all duration-100 ease-in-out hover:border-l-4 hover:border-l-rose-600 hover:text-rose-600 focus:border-l-4">
                                    <svg class="mr-4 h-5 w-5 align-middle" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
