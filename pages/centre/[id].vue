    ...
    <div class="">
        <section class="lg:py-12 lg:flex lg:justify-center">
            <div class="overflow-hidden bg-white lg:mx-8 lg:flex lg:max-w-6xl lg:w-full lg:shadow-md lg:rounded-xl">
                <div class="lg:w-1/3">
                    ...
                    <img src="@/assets/img/centre/c1.jpg" alt="" class="h-full">
                </div>
        ...
        <div class="lg:mx-20 mb-20">
            <div class="grid grid-cols-1 md:grid-cols-3">
                <div class="p-3" v-for="co in data.attributes.courses.data">
...
let centre = ref('')
let url = `http://localhost:1337/api/centres/${id}?populate=courses`
