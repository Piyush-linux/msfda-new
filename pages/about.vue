<template>
    <div class="mx-20">
                    ...
                    <div class="w-full px-4 lg:w-1/2 xl:w-5/12">
                        <div class="mt-10 lg:mt-0">
                            ...
                            <p class="text-body-color mb-8 text-base">
                                The Government of Maharashtra has established Maharashtra State Faculty Development Academy (MSFDA) under Section 8 of Companies Act, 2013 to impart training to the faculty of Higher and Technical Education Institutions of Maharashtra.
                            </p>
                            <a href="javascript:void(0)" class="bg-primary inline-flex items-center justify-center rounded-lg py-4 px-10 text-center text-base font-normal text-white hover:bg-opacity-90 lg:px-8 xl:px-10">
                                Get Started
                            </a>
                        </div>
                    </div>
        ...
        <!-- ====== About Section End -->
        <!-- Container -->
        <div class="relative flex flex-col items-center mx-auto lg:flex-row-reverse lg:max-w-5xl lg:my-12 xl:max-w-6xl">
            <!-- Image Column -->
            ...
            <div class="max-w-lg bg-white md:max-w-2xl md:z-10 md:shadow-lg md:absolute md:top-0 md:mt-48 lg:w-3/5 lg:left-0 lg:mt-20 lg:ml-20 xl:mt-24 xl:ml-12">
                <!-- Text Wrapper -->
                <div class="flex flex-col mt-6 sm:p-12 md:px-16">
                    <h2 class="text-2xl font-medium uppercase text-sky-500 lg:text-4xl">The National Education Policy (NEP) 2020 specifies: </h2>
                    <p class="mt-4">
                        13.1 - The most important factor in the success of higher education institutions is the quality and engagement of its faculty.
                    </p>
                    <p class="mt-4">
                        15.1.1 - Teacher education is vital in creating a pool of teachers that will shape the next generation. Teacher preparation is an activity that requires multidisciplinary perspectives and knowledge, formation of dispositions and values, and development of practice under the best mentors. Teachers must be grounded in Indian values, languages, knowledge, ethos, and traditions including tribal traditions, while also being well-versed in the latest advances in education and pedagogy
                    </p>
                </div>
            </div>
        </div>
