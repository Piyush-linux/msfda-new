<template>
        <div class="">
            <!-- component -->
            <div class="h-screen bg-gray-200  bg-gray-100   flex flex-wrap items-center  justify-center  ">
                <div class="container lg:w-2/6 xl:w-2/7 sm:w-full md:w-2/3    bg-white  shadow-lg    transform   duration-200 easy-in-out">
                    ...
                    <div class="flex justify-center px-5  -mt-12">
                        <img class="h-32 w-32 bg-white object-cover p-2 rounded-full" src="@/assets/favicon/bg.png" alt="" />
                    </div>
                    <div class=" ">
                        <div class="text-center px-14">
                            ...
                            <a class="text-gray-400 mt-2 hover:text-blue-500" href="https://www.instagram.com/immohitdhiman/" target="BLANK()">
                            	{{ user.email }}
                            </a>
                        ...
                        <hr class="mt-6" />
                        <!-- <div class="flex  bg-gray-50 p-3">
                            <div class="text-center bg-emerald-300 w-full p-4 hover:bg-gray-100 cursor-pointer">
                                <p> E D I T</p>
                            </div>
